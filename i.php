...
<body>
	...
	if (isset($_GET["d"])) {
		...
		$sql = mysqli_query($con, "delete from student where Sid=" . $_GET["d"]);
	...
	echo '<fieldset id="fieldtable" ><legend>Students</legend> <table id="idtable2" >
		<tr>
	...
	while ($f = mysqli_fetch_array($sql)) {
		...
		echo '<td align=center><a id="edetingancor" href=index.php?d=' . $f["admin_id"] . '>Delete&nbsp;<i class="fa-solid fa-file-circle-minus"></i></a></td>';
		echo '</tr>';
		$i += 1;
	}
	echo '</table></fieldset>';
